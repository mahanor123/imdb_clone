...
const { Author, Book, UpcomingReleases } = require('./sequelize')
const app = express()
...
//create a movie
app.post('/demoApi/UpcomingReleases', (req, res) => {
    console.log(req.body)
    UpcomingReleases.create(req.body)
    .then(UpcomingReleases => res.json(UpcomingReleases))
    })
// create a book
